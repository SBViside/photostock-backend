...
router.get('/images/user/:id', imageController.userImages); // REVIEW | USER IMAGES BY PAGE

router.get('/user', [authOnlyMiddleware], userController.getSelfInfo); // REVIEW | SELF INFO | AUTH ONLY
router.get('/user/:id', userController.getUserInfo); // REVIEW | USER INFO 
